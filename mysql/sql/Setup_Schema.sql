...
VALUES (1, 'Blitzburg Steelheads', 666666666, 534615656, 'WWU', 1, 77, 64, 14),
       (2, 'Brawltimore Razors', 666666667, 118072692, 'UW', 2, 22, 78, 3),
       (3, 'Cracksumskull Jugulars', 666666668, 406210010, 'CWU', 3, 0, 0, 88),
       (4, 'Full Metal Mayhem', 666666669, 15309766, 'UBC', 4, 59, 93, 0),
       (5, 'Galaxy Chaos', 666666670, 24449374, 'SPU', 5, 34, 38, 8),
       (6, 'Insane Cults', 666666671, 765040826, 'EWU', 6, 8, 31, 30),
       (7, 'Hexxon Oilers', 666666672, 617043149, 'Gonzaga', 7, 18, 98, 0);

# Insert Players
INSERT INTO `PLAYERS`
VALUES (111111100, 1, 'Jared James', '123 Peachtree, Atlanta, GA', '1966-10-10', 'running back', 'WWU', 3, 'freshman', 3),
       (111111101, 1, 'Jon Jones', '111 Allgood, Atlanta, GA', '1967-11-14', 'inside receiver', 'WWU', 3, 'sophomore', 3),
       (111111102, 1, 'Justin Mark', '2342 May, Atlanta, GA', '1966-01-12', 'quarterback', 'WWU', 1, 'junior', 2),
       (222222200, 1, 'Evan Wallis', '134 Pelham, Milwaukee, WI', '1958-01-16', 'tackler', 'WWU', 1, 'senior',
        4),
       (222222201, 1, 'Josh Zell', '266 McGrady, Milwaukee, WI', '1954-05-22', 'guard', 'WWU', 4, 'freshman', 3),
       ...
       (222222205, 2, 'Chris Carter', '565 Jordan, Milwaukee, WI', '1960-03-21', 'center player player', 'UW', 2, 'senior', 4),
       (333333300, 2, 'Kim Grace', '6677 Mills Ave, Sacramento, CA', '1970-10-23', 'running back', 'UW', 6, 'freshman', 2),
       (333333301, 2, 'Jeff Chase', '145 Bradbury, Sacramento, CA', '1970-01-07', 'quarterback', 'UW', 6, 'sophomore',
        3),
       (444444400, 2, 'Alex Freed', '4333 Pillsbury, Milwaukee, WI', '1950-10-09', 'tackler', 'UW', 4, 'junior',
        1),
       (444444401, 2, 'Bonnie Bays', '111 Hollow, Milwaukee, WI', '1956-06-19', 'guard', 'UW', 4, 'senior', 4),
       ...
       (444444403, 2, 'Sam Snedden', '987 Windy St, Milwaukee, WI', '1977-07-31', 'wide receiver', 'UW', 3, 'sophomore',
        2),
       (555555500, 3, 'John James', '7676 Bloomington, Sacramento, CA', '1975-06-30', 'quarterback', 'CWU', 4, 'junior', 1),
       (555555501, 3, 'Nandita Ball', '222 Howard, Sacramento, CA', '1969-04-16', 'inside receiver', 'CWU', 3, 'senior', 3),
       (666666600, 3, 'Bob Bender', '8794 Garfield, Chicago, IL', '1968-04-17', 'quarterback', 'CWU', 3, 'freshman', 3),
       (666666601, 3, 'Jill Jarvis', '6234 Lincoln, Chicago, IL', '1966-01-14', 'tackler', 'CWU', 5,
        'sophomore', 2),
       (666666602, 3, 'Kate King', '1976 Boone Trace, Chicago, IL', '1966-04-16', 'guard', 'CWU', 2, 'junior', 1),
       ...
       (666666604, 3, 'Billie King', '556 Washington, Chicago, IL', '1960-01-01', 'wide receiver', 'CWU', 3, 'freshman',
        2),
       (666666605, 4, 'Jon Kramer', '1988 Windy Creek, Seattle, WA', '1964-08-22', 'inside receiver', 'UBC', 4, 'sophomore', 2),
       (666666606, 4, 'Ray King', '213 Delk Road, Seattle, WA', '1949-08-16', 'center player', 'UBC', 2, 'junior', 2),
       (666666607, 4, 'Gerald Small', '122 Ball Street, Dallas, TX', '1962-05-15', 'quarterback', 'UBC', 2, 'senior',
        3),
       (666666608, 4, 'Arnold Head', '233 Spring St, Dallas, TX', '1967-05-19', 'tackler', 'UBC', 4, 'freshman',
        2),
       (666666609, 4, 'Helga Pataki', '101 Holyoke St, Dallas, TX', '1969-03-11', 'guard', 'UBC', 4, 'sophomore', 2),
       ...
       (666666611, 4, 'Carl Reedy', '213 Ball St, Philadelphia, PA', '1977-06-21', 'wide receiver', 'UBC', 5, 'senior',
        3),
       (666666612, 5, 'Sammy Hall', '433 Main Street, Miami, FL', '1970-01-11', 'inside receiver', 'SPU', 5, 'freshman', 2),
       (666666613, 5, 'Red Bacher', '196 Elm Street, Miami, FL', '1980-05-21', 'center player', 'SPU', 5, 'sophomore', 1),
       (666666614, 5, 'James Borg', '450 Stone, Houston, TX', '1927-11-10', 'quarterback', 'SPU', 6, 'junior', 2),
       (666666615, 5, 'Jeffrey Geoffrey', '451 Stone, Houston, TX', '1927-11-11', 'tackler', 'SPU', 4, 'senior',
        1),
       (666666616, 5, 'VIKKI SCHEUERLEIN', '452 Stone, Houston, TX', '1927-11-12', 'guard', 'SPU', 6, 'freshman', 1),
       ...
       (666666618, 5, 'ROSELYN SCHIEFERDECKER', '454 Stone, Houston, TX', '1927-11-14', 'wide receiver', 'SPU', 5,
        'junior', 2),
       (666666619, 6, 'MELVINA SCHINTZIUS', '455 Stone, Houston, TX', '1927-11-15', 'inside receiver', 'EWU', 1, 'senior', 3),
       (666666620, 6, 'JANNETTE SCHLENVOGT', '456 Stone, Houston, TX', '1927-11-16', 'center player', 'EWU', 1, 'freshman', 4),
       (666666621, 6, 'GINNY SCHNEIR', '457 Stone, Houston, TX', '1927-11-17', 'quarterback', 'EWU', 3, 'sophomore', 1),
       (666666622, 6, 'ANISSA SCUTCHFIELD', '458 Stone, Houston, TX', '1927-11-18', 'tackler', 'EWU', 6,
        'junior', 2),
       (666666623, 6, 'VIVIANA SEADORF', '459 Stone, Houston, TX', '1927-11-19', 'guard', 'EWU', 1, 'senior', 3),
       ...
       (666666625, 6, 'SHARYN SETCHEL', '461 Stone, Houston, TX', '1927-11-21', 'wide receiver', 'EWU', 4, 'sophomore',
        1),
       (666666626, 7, 'CHANTAL SETKA', '462 Stone, Houston, TX', '1927-11-22', 'inside receiver', 'Gonzaga', 2, 'junior', 4),
       (666666627, 7, 'NIKI SGARLATO', '463 Stone, Houston, TX', '1927-11-23', 'center player', 'Gonzaga', 6, 'senior', 4),
       (666666628, 7, 'MAUD SHAFRON', '464 Stone, Houston, TX', '1927-11-24', 'quarterback', 'Gonzaga', 2, 'freshman',
        1),
       (666666629, 7, 'LIZETTE SHAMLOO', '465 Stone, Houston, TX', '1927-11-25', 'tackler', 'Gonzaga', 4,
        'sophomore', 4),
       (666666630, 7, 'LINDY SHCHERBAKOV', '466 Stone, Houston, TX', '1927-11-26', 'guard', 'Gonzaga', 3, 'junior',
        1),
...
VALUES ('2014-11-01', 'Blitzburg', 5, 1, 666666670, 24449374, '8000 - 7'),
       ('2015-11-02', 'Brawltimore', 2, 4,  666666669, 15309766, '90 - 43'),
       ('2016-11-03', 'Seattle', 6, 1, 666666671, 765040826, '59 - 30'),
       ('2017-11-04', 'Toronto', 7, 2, 666666672, 617043149, '800 - 799'),
       ('2018-11-05', 'Toronto', 5, 2, 666666670, 24449374, '0 - 1'),
       ('2019-11-06', 'Brawltimore', 4, 6, 666666668, 406210010, '90 - 78'),
       ('2020-11-07', 'Blitzburg', 2, 1, 666666667, 118072692, '9999 - 800');

# Insert Allstar Nominees
INSERT INTO `ALLSTAR_NOMINEES`
VALUES (111111100, '2014-11-01', 'Blitzburg', 1),
       (111111101, '2015-11-02', 'Brawltimore', 2),
       (111111102, '2016-11-03', 'Seattle', 3),
       (222222200, '2017-11-04', 'Toronto', 4),
       (222222201, '2018-11-05', 'Toronto', 5),
       (222222203, '2019-11-06', 'Brawltimore', 6),
       (222222204, '2020-11-07', 'Blitzburg', 7);
